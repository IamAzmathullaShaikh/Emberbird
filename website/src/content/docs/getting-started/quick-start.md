...
1. Download the recommended release from the Emberbird Web Portal (`/downloads`) or the official GitHub Releases page: `https://github.com/IamAzmathullaShaikh/Emberbird/releases`.
